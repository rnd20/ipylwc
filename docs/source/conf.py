...
# -*- coding: utf-8 -*-
#
# ipylwc documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipylwc', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipylwc.tex', 'ipylwc Documentation',
     '4thturning', 'manual'),
]
